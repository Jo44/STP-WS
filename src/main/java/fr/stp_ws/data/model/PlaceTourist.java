 ...
 */
@Entity
@Table(name = "places_tourist")
public class PlaceTourist extends Place {
	 ...
	 * @param photos
	 */
	public PlaceTourist(Integer id, User owner, EntityType type, String times, Double latitude, Double longitude,
